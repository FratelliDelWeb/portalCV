...
exports.getAppuntamentiDaRifissare = async (req, res, next) => {
  try{
      const data = await Model.find(
          {Esito : "E04"}
      );
...
exports.updateAppuntamento = async (req, res, next) => {
...
exports.searchAppuntamento = async (req, res, next) => {
  try{
